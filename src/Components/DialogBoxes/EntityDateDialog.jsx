...
const EntityDateDialog = ({ show, handleClose, handleConfirm, message, entityOptions, optionsLoading = false }) => {

	const schema = object().shape({
        select: object().required("Select an option from the drop down"),
        startDate: date(),
...
export default EntityDateDialog;