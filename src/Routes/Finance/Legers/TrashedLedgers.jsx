			...
			switch (confirmDialogEvtName) {
				case 'restore':
					...
					if(indexPos > -1){
						...
						toast.success('Ledger successfully restored');
					}
                    //  update in ledgers arr also contact
                    indexPos = ledgers.findIndex(i => i.id === data.id);
                    if(indexPos > -1){
            ...
            <div className="container mx-auto d-flex flex-column bg-primary rounded-4 rounded-bottom-0 m-3 text-white align-items-center" >
                ...
                <div className="text-center d-flex">
                    <h2 className="display-6 p-3 mb-0">
                        <span className="me-4 fw-bold" style={{textShadow: "3px 3px 3px black"}}>Trash (Ledgers)</span>
                        <img src={SVG.ledger} style={{ width: "50px", height: "50px" }} />
                    </h2>
                </div>
                <span className='text-center m-1'>
                    View, Restore deleted ledgers.
                </span>
            </div>
